...
public class JCalendarPanel extends JPanel
{
	...
	private void displayMonths()
	{
		...
		comboBoxMonth.setModel(new DefaultComboBoxModel(new String[] { getMonthFromInt(0), getMonthFromInt(1), getMonthFromInt(2), getMonthFromInt(3), getMonthFromInt(4), getMonthFromInt(5), getMonthFromInt(6), getMonthFromInt(7),
