...
public class JDatabaseParameters
{
	...
	public String getjdbcConnectString() {
		...
		//PG add ->
		if (getjdbcDriver().equals("org.postgresql.Driver"))
		{
			if (getjdbcServer().equals("") == true)
			{
				value = "jdbc:postgresql:";
			}
			else
			{
				value = "jdbc:postgresql://"+"jdbcServer";
			}
			if (getjdbcPort().equals("")==false)
			{
				if (getjdbcPort().equals("5432")==false)
				{
					value = value + ":"+"jdbcPort";
				}
			}
			if (getjdbcDatabase().equals("") == true)
			{
				value = value + "/"+"postgres";
			}
			else
			{
				value = value + "/"+"jdbcDatabase";
			}
		}
		//PG add end
