...
public class JInternalFrameMaterialBatchAdmin extends JInternalFrame
{
	...
	private void initGUI() {
		try
		{
			...
			this.setBounds(0, 0, 448+Common.LFAdjustWidth, 603+Common.LFAdjustHeight);
			setVisible(true);
			...
			this.setTitle("Material Batches");
			{
				...
				jDesktopPane1.setPreferredSize(new java.awt.Dimension(483, 266));
				{
					...
					jScrollPane1.setBounds(0, 196, 425, 337);
					{
				...
				}
				{
					...
					jTextFieldBatch.setBounds(99, 37, 141, 21);
				}
				{
					...
					jLabel10.setBounds(0, 157, 91, 21);
				}
				{
					...
					jComboBoxSortBy.setBounds(99, 157, 141, 23);
				}
				{
				...
				}
				{
					...
					jToggleButtonSequence.setBounds(246, 157, 21, 21);
...

				{
					...
					jButtonLookupBatch.setBounds(246, 37, 21, 21);
					jDesktopPane1.add(jButtonLookupBatch);
				}

				{
					expiryFrom.setBounds(120, 93, 125, 25);
					expiryFrom.setEnabled(false);
					jDesktopPane1.add(expiryFrom);
				}

				{
					expiryTo.setBounds(120, 125, 125, 25);
					expiryTo.setEnabled(false);
...

				{
					...
					jLabel5_1.setBounds(0, 97, 91, 21);
...

				{
					...
					jLabel5_2.setBounds(0, 129, 91, 21);
...

				{
					...
					jCheckBoxFrom.setBounds(99, 93, 21, 21);
...

				{
					...
					jCheckBoxTo.setBounds(99, 125, 21, 21);
...

				{
					...
					jStatusText.setBounds(5, 535, 405, 21);
				...
				
				{
					...
					calendarButtonexpiryFrom.setEnabled(false);
					calendarButtonexpiryFrom.setBounds(248, 96, 21, 21);
					jDesktopPane1.add(calendarButtonexpiryFrom);
				}
				{
					calendarButtonexpiryTo = new JCalendarButton(expiryTo);
					calendarButtonexpiryTo.setEnabled(false);
					calendarButtonexpiryTo.setBounds(248, 129, 21, 21);
