...
public class JInternalFrameMaterialUomAdmin extends javax.swing.JInternalFrame
{
	...
	private void initGUI() {
		try
		{
			...
			this.setBounds(0, 0, 637+Common.LFAdjustWidth, 262+Common.LFAdjustHeight);
			setVisible(true);
			this.setIconifiable(true);
			{
				...
				this.getContentPane().add(jDesktopPane1, BorderLayout.CENTER);
				{
					...
					jScrollPane1.setBounds(7, 7, 469, 174);
					{
				...
				}
				{
					...
					jButtonPrint.setBounds(483, 91, 126, 28);
				...
				}
				{
					...
					jButtonHelp.setText(lang.get("btn_Add"));
					jButtonHelp.setMnemonic(lang.getMnemonicChar());
					jButtonHelp.setBounds(483, 147, 126, 28);
				}
				{
					...
					jButtonClose.setBounds(483, 175, 126, 28);
				...
				}
				{
					...
					jButtonRefresh.setBounds(483, 119, 126, 28);
