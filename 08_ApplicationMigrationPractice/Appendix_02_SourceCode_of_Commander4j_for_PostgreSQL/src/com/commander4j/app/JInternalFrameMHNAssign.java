...
public class JInternalFrameMHNAssign extends JInternalFrame
{
	...
	public JInternalFrameMHNAssign(JInternalFrameMHNProperties callingForm, String mhnnumber) {
		...
		jButtonAssign.setBounds(245, 138, 120, 28);
		...
		try
		{
...

			{
				...
				}
				{
					...
					jButtonSearch.setBounds(2, 138, 120, 28);
	...
	private void populateList()
	{
		...
		jTable1.getColumnModel().getColumn(JDBMHNPalletTableModelAssign.Quantity_Col).setPreferredWidth(60);
		...
		jTable1.getColumnModel().getColumn(JDBMHNPalletTableModelAssign.SSCC_Status_Col).setPreferredWidth(132);
