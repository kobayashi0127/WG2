...
public class JInternalFrameMHNAdmin extends JInternalFrame
{
	...
	private JComboBox4j jTextFieldStatus;
	...
	private void create()
	{
		...
		int n = JOptionPane.showConfirmDialog(Common.mainForm, "Create New Master Hold ?", "Confirm", JOptionPane.YES_NO_OPTION);
		if (n == 0)
		{
	...
	private void deleteRecord()
	{
		...
		if (row >= 0)
		{
			...
			int n = JOptionPane.showConfirmDialog(Common.mainForm, "Delete MHN " + lMHN + " ?", "Confirm", JOptionPane.YES_NO_OPTION);
			if (n == 0)
			{
		...
		try
		{
			...
			this.setTitle("MHN Administration");
			{
...

				{
					...
					jButtonClear.setBounds(107, 118, 106, 28);
