...
public class JInternalFrameMenuStructure extends javax.swing.JInternalFrame
{
	...
	private void populateMenuList() {
		...
		ListModel jList1Model = menuModel;
		jListMenus.setCellRenderer(Common.renderer_list);
		jListMenus.setModel(jList1Model);
	}

	private void refreshJList(JDBModuleJList jlist, DefaultComboBoxModel comboboxmodel, LinkedList<JDBListData> linkedlist) {
		...
		try
		{
			...
			this.setClosable(true);
			{
				...
				jDesktopPane1.setLayout(null);
				{
					...
					{
						ListModel jListMenusModel = new DefaultComboBoxModel(new String[] { "" });
				...
				}
				{
					...
					jButtonClose.setBounds(504, 377, 116, 30);
				...
				}
				{
					...
					jButtonSave.setBounds(150, 377, 116, 30);
				...
				}
				{
					...
					jButtonHelp.setBounds(386, 377, 116, 30);
				...
				}
				{
					...
					jButtonUndo.setBounds(268, 377, 116, 30);
					jButtonUndo.setEnabled(false);
